-- V8__protect_sale_total_amount.sql
-- ============================================================
...
-- ============================================================
-- TRIGGER: trg_validate_sale_total_amount
-- ============================================================
-- Validates total_amount before INSERT or UPDATE on core.sale.
-- ============================================================

CREATE TRIGGER trg_validate_sale_total_amount
BEFORE INSERT OR UPDATE
ON core.sale
FOR EACH ROW
EXECUTE FUNCTION core.fn_validate_sale_total_amount();